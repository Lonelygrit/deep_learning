...
CLASSES = ["ALL","AML","CML","L","MDS/MPN","MM","HEALTHY"]
hist = torch.tensor([[0.96,0.03,0.01,0.00,0.00,0.00,0.00],
                        [0.01,0.94,0.01,0.01,0.02,0.01,0.00],
                        [0.00,0.00,0.92,0.00,0.05,0.03,0.00],
                        [0.00,0.02,0.00,0.96,0.00,0.02,0.00],
                        [0.00,0.04,0.03,0.01,0.91,0.01,0.00],
                        [0.00,0.00,0.00,0.01,0.01,0.98,0.00],
                        [0.00,0.00,0.03,0.01,0.00,0.01,0.95]])
hist = (hist*100).type(torch.int8)
hist = hist.numpy()
